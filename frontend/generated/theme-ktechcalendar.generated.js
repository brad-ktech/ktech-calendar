...
import stylesCss from 'themes/ktechcalendar/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_ktechcalendar_componentCss']) {
    
    document['_vaadintheme_ktechcalendar_componentCss'] = true;
  }
